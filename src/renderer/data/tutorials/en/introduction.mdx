...
can be enabled by setting the [`tex`](https://alphatab.net/docs/reference/settings/core/tex) option or loading it via [`tex()`](https://alphatab.net/docs/reference/api/tex) method on the API.
